...
var findMedianSortedArrays = function (nums1, nums2) {
    ...
    while (merged.length < ((m + n) / 2 + 1)) {
        ...
        if (i1 >= m) {
            merged.push.apply(merged, nums2.slice(i2));
            break;
        }
        if (i2 >= n) {
            merged.push.apply(merged, nums1.slice(i1));
            break;
        }
    ...
    var medianIndex = Math.floor((len - 1) / 2);
...
//# sourceMappingURL=medianSortedArr.js.map